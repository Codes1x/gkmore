...
export function ModernFAQ() {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer: "Покажем калькуляцию 'до/после': все расходы прозрачны и учитываются до распределения доходов. При самостоятельном управлении ваши затраты на маркетинг, клининг, техподдержку и время составят больше 30%. Мы берём на себя все операционные риски.",
      icon: "💰",
      category: "Финансы"
    }
  ];
